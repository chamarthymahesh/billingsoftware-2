...
const Companies = () => {
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      await axios.put(
        `${API}/api/users/${selectedUser._id}/reset-password`,
        { newPassword },
        { headers: { ...config.headers, "Content-Type": "application/json" } },
      );
            ...
            <div key={company._id} className="cp-card">
              <div
                ...
                style={{
                  ...
                  borderBottom: `1px solid ${getColor(i)}33`,
                }}
              >
                ...
                <div className="cp-card-actions">
                  <button className="cp-action-btn view" title="View Details">
                    <Eye size={16} />
                  </button>
                  <button
                    className="cp-action-btn reset"
                    title="Reset Password"
                    onClick={() => {
                      setSelectedUser(company.adminUser);
        ...
        <div className="cp-overlay" onClick={(e) => e.target === e.currentTarget && setIsModalOpen(false)}>
          <div className="cp-modal">
            ...
            <div className="cp-modal-header">
              ...
              <button className="cp-close" onClick={() => setIsModalOpen(false)}>
                <X size={18} />
              </button>
            </div>
            ...
            <form onSubmit={handleCreate} className="cp-modal-body">
              ...
              <div className="cp-section-divider">
                <span>
                  <Shield size={13} /> Admin Account Details
                </span>
              </div>
              <div className="cp-form-grid">
                <div className="cp-field">
              ...
              <div className="cp-modal-footer">
                <button type="button" className="cp-btn-cancel" onClick={() => setIsModalOpen(false)}>
                  Cancel
                </button>
                <button type="submit" className="cp-btn-create">
        ...
        <div className="cp-overlay" onClick={(e) => e.target === e.currentTarget && setIsResetModalOpen(false)}>
          <div className="cp-modal cp-modal-sm">
            <div className="cp-modal-header">
              ...
              <button className="cp-close" onClick={() => setIsResetModalOpen(false)}>
                <X size={18} />
              </button>
            </div>
            <form onSubmit={handleResetPassword} className="cp-modal-body">
              <p className="cp-reset-info">
                Resetting password for admin: <strong>{selectedUser?.email}</strong>
              </p>
              ...
              <div className="cp-modal-footer">
                <button type="button" className="cp-btn-cancel" onClick={() => setIsResetModalOpen(false)}>
                  Cancel
                </button>
                <button
                  type="submit"
